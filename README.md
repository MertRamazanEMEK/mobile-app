...
<div style="display: flex; justify-content: space-around;">
    <img src="./images/Giris_Ekrani.jpg" width="200" alt="Giriş Ekranı">
    <img src="./images/Urunler_Ekrani.jpg" width="200" alt="Ürün Arama Ekranı">
    <img src="./images/Favoriler_Ekrani.jpg" width="200" alt="Favoriler Ekranı">
    <img src="./images/Ayarlar_Ekrani.jpg" width="200" alt="Ayarlar Ekranı">
</div>
